...
(function () {
    ...
    const isNamedAnchorNode = node => isEmptyString(node.attr('href')) &&
    ...
    const register = editor => {
        ...
        editor.ui.registry.addToggleButton('anchor', {
            ...
            tooltip: 'Anchor',
            onAction,
            onSetup: buttonApi => editor.selection.selectorChangedWithUnbind('a:not([href])',
                buttonApi.setActive).unbind
        });
