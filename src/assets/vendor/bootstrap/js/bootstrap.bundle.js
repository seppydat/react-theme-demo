...
(function (global, factory) {
    ...
    function addHandler(element, originalTypeEvent, handler, delegationFunction, oneOff) {
        ...
        const fn = isDelegated ? bootstrapDelegationHandler(element, handler, callable) : bootstrapHandler(element,
            callable);
    ...
    const Data = {
        set(element, key, instance) {
            ...
            if (!instanceMap.has(key) && instanceMap.size !== 0) {
                ...
                console.error(`Bootstrap doesn't allow more than one instance per element. Bound instance: ${Array.from(
                    instanceMap.keys())[0]}.`);
                return;
            }
        ...
        return function () {
            Object.keys(state.elements).forEach(function (name) {
                ...
                var styleProperties = Object.keys(
                    state.styles.hasOwnProperty(name) ? state.styles[name] : initialStyles[name]); // Set all values to an empty string to unset them
    ...
    function mapToStyles(_ref2) {
        ...
        if (gpuAcceleration) {
            ...
            return Object.assign({}, commonStyles,
                (_Object$assign = {}, _Object$assign[sideY] = hasY ? '0' : '', _Object$assign[sideX] = hasX
                    ? '0'
                    : '', _Object$assign.transform = (win.devicePixelRatio || 1) <= 1 ? 'translate(' + x + 'px, ' + y +
                    'px)' : 'translate3d(' + x + 'px, ' + y + 'px, 0)', _Object$assign));
        }

        return Object.assign({}, commonStyles,
            (_Object$assign2 = {}, _Object$assign2[sideY] = hasY ? y + 'px' : '', _Object$assign2[sideX] = hasX ? x +
    ...
    function getDocumentRect(element) {
        ...
        var height = max(html.scrollHeight, html.clientHeight, body ? body.scrollHeight : 0,
  ...
  */
    ...
    function preventOverflow(_ref) {
        ...
        if (checkMainAxis) {
            ...
            var offsetModifierValue = (_offsetModifierState$ = offsetModifierState == null
                ? void 0
                : offsetModifierState[mainAxis]) != null ? _offsetModifierState$ : 0;
            var tetherMin = offset + minOffset - offsetModifierValue - clientOffset;
            var tetherMax = offset + maxOffset - offsetModifierValue;
            var preventedOffset = within(tether ? min(min$1, tetherMin) : min$1, offset,
        ...
        if (checkAltAxis) {
            ...
            var _offsetModifierValue = (_offsetModifierState$2 = offsetModifierState == null
                ? void 0
            ...
            var _preventedOffset = tether && isOriginSide ? withinMaxClamp(_tetherMin, _offset, _tetherMax) : within(
                tether ? _tetherMin : _min, _offset, tether ? _tetherMax : _max);
            ...
            var instance = {
                ...
                setOptions: function setOptions(setOptionsAction) {
                    ...
                    var orderedModifiers = orderModifiers(
                        mergeByName([].concat(defaultModifiers, state.options.modifiers))); // Strip out disabled modifiers
    ...
    class Tooltip extends BaseComponent {
        ...
        _createPopper(tip) {
            const placement = typeof this._config.placement === 'function' ? this._config.placement.call(this, tip,
